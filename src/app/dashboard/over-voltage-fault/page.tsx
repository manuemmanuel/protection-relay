...
export default function OverVoltageFaultDetails() {
  const router = useRouter()

  const data = [
    { category: 'Category 1', series1: 50, series2: 75 },
    { category: 'Category 2', series1: 30, series2: 75 },
    { category: 'Category 3', series1: 40, series2: 65 },
    { category: 'Category 4', series1: 35, series2: 60 },
  ]
    ...
    <div className={`min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-2 sm:p-4 ${aeonik.className}`}>
      <div className="bg-gray-800/50 backdrop-blur-sm p-4 rounded-xl border border-gray-700 shadow-lg">
        ...
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-xl font-bold text-gray-100">Over-Voltage Fault</h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-800/50 backdrop-blur-sm p-4 rounded-xl border border-gray-700">
            <h3 className="font-bold mb-3 text-gray-100">Set Voltage</h3>
